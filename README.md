...
- **Quatro conferências diferentes, e cada uma responde por uma coisa só** — a distinção existe porque durante muito tempo eu chamei a primeira de "validação", e ela não é:
